        ...
        <FormSection>
          ...
          <FormGrid>
            <FormGroup>
              <InputLabel>
                ...
                <span className='info-icon'>
                  ⓘ<Tooltip>캠페인이 시작될 날짜와 시간을 선택해주세요</Tooltip>
                </span>
              </InputLabel>
              <InputWrapper>
                <Input
            ...
            <FormGroup>
              <InputLabel>
                ...
                <RequiredMark>*</RequiredMark>
                <span className='info-icon'>
                  ⓘ<Tooltip>캠페인이 종료될 날짜와 시간을 선택해주세요</Tooltip>
                </span>
              </InputLabel>
              <InputWrapper>
                <Input
          ...
          <FormGroup>
            <InputLabel>
              ...
              <RequiredMark>*</RequiredMark>
              <span className='info-icon'>
                ⓘ<Tooltip>달성하고자 하는 총 판매 목표 수량을 입력해주세요</Tooltip>
              </span>
            </InputLabel>
            <InputWrapper>
              <Input
        ...
        <FormSection>
          ...
          <FormGroup>
            <InputLabel>
              ...
              <RequiredMark>*</RequiredMark>
              <span className='info-icon'>
                ⓘ<Tooltip>판매할 상품의 이름을 입력해주세요</Tooltip>
              </span>
            </InputLabel>
            <InputWrapper>
              <Input
          ...
          <FormGroup>
            <InputLabel>
              ...
              <RequiredMark>*</RequiredMark>
              <span className='info-icon'>
                ⓘ<Tooltip>상품에 대한 자세한 설명을 입력해주세요</Tooltip>
              </span>
            </InputLabel>
            <InputWrapper>
              <textarea
          ...
          <FormGrid>
            <FormGroup>
              <InputLabel>
                ...
                <RequiredMark>*</RequiredMark>
                <span className='info-icon'>
                  ⓘ<Tooltip>상품의 판매 가격을 입력해주세요</Tooltip>
                </span>
              </InputLabel>
              <InputWrapper>
                <Input
            ...
            <FormGroup>
              <InputLabel>
                ...
                <RequiredMark>*</RequiredMark>
                <span className='info-icon'>
                  ⓘ<Tooltip>준비된 총 재고 수량을 입력해주세요</Tooltip>
                </span>
              </InputLabel>
              <InputWrapper>
                <Input
